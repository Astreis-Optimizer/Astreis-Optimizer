...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.right_column_frame.setMinimumWidth(self.settings["right_column_size"]["maximum"])
        self.right_column_frame.setMaximumWidth(self.settings["right_column_size"]["maximum"])
        ...
        # Add close button to right column
        # (No need to add self.right_column_close_btn to any layout here)
    ...
    def close_right_column(self):
        # Show subscription message box
        themes = Themes().items
        msg_box = QMessageBox(self)
        msg_box.setWindowTitle("Premium Features")
        msg_box.setText("Unlock Premium Features!")
        msg_box.setInformativeText("Get access to advanced optimization tools and exclusive features with our premium subscription.")
        msg_box.setStyleSheet(
            f"QMessageBox {{ background-color: {themes['app_color']['dark_one']}; color: {themes['app_color']['text_foreground']}; }}"
            f"QPushButton {{ background-color: {themes['app_color']['context_color']}; color: {themes['app_color']['text_foreground']}; border-radius: 8px; padding: 5px; }}"
            f"QPushButton:hover {{ background-color: {themes['app_color']['context_hover']}; }}"
        )
